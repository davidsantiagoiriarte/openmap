...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        // TO DO (5) Store an address in a String

        // TO DO (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address

        // TO DO (7) Replace the Toast with a call to showMap, passing in the Uri from the previous step
        Toast.makeText(this, adressUri.toString(), Toast.LENGTH_LONG).show();
        showMap(adressUri);
    }
...
public void showMap(Uri link){
    ...
    // TO DO (1) Create a method called showMap with a Uri as the single parameter
    // Do steps 2 - 4 within the showMap method
        // TO DO (2) Create an Intent with action type, Intent.ACTION_VIEW

        // TO DO (3) Set the data of the Intent to the Uri passed into this method

        // TO DO (4) Verify that this Intent can be launched and then call startActivity
